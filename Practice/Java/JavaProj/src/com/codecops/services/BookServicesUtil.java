...
public class BookServicesUtil implements 
     ...
     * sort by rating.
     */
    public static void sortByRating(List<Book> booksList) {
    ...
    public static void sortByAuthor(List<Book> booksList) {
     ...
     */
    public static void sortByName(List<Book> booksList) {
     ...
     * to sort book by ID
     */
    public static void sortByID(List<Book> booksList) {
     ...
     */
    public static int searchByID(int id, List<Book> booksList) {
     ...
     */
    public static int searchByName(String name, List<Book> booksList) {
    ...
    public static int searchByAuthor(String author, List<Book> booksList) {
     ...
     */
    public static int searchByRating(double rating, List<Book> booksList) {
...
//    }
     ...
     */
    public static void displayBookList(List<Book> booksList) {
    ...
    public void issueBook(int memberId, int bookId, Database database) {
        Member members = null;
        for (Member member : database.membersList) {
