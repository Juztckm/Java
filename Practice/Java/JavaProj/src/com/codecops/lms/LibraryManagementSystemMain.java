...
public class LibraryManagementSystemMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Admin admin = new Admin(999, "Admin", 999999999, "admin"); //object of Admin instantiated.
        ...
        do {
            ...
            /*
             * login choices made available to user
             */
            switch (chooseUser) {
            case 1:
                do {
                    ...
                    case 1:
                    	...
                    	{
                    		System.out.println("Enter valid details of user...");
                    		System.out.print("Again Enter Mobile no.:  ");
                    		scanner.next();
                    	}
                    	}while(flag==0);
                        break;
                    case 2:
                        ...
                        case 1:
                            ...
                            adminServices.updateUserDetails(database,
                                    adminUpdateName, userId);
                            break;
                        case 2:
                        ...
                        case 3:
                            ...
                            adminServices.updateUserDetails(database,
                                    adminUpdateMobileNumber, userId);
                        	}
                        	catch(Exception ex)
                        	{
                    ...
                    case 5:
                        ...
                        adminServices.addBook(database, bookName, authorName,
                                rating);
                    	}
                    	catch(Exception ex)
                    	{
                    		System.out.println("Enter valid book details");
                    	}
                        break;
                    case 6:
                    	int bookId;
                    ...
                    case 7:
                    	...
                    	{
                    		System.out.println("Enter a valid bookId??1");
                    	}
                        break;
                    case 8:
                ...
                do {
                    if (memberSession == 0) {
                        do {
                            ...
                            if (Member.loginCheck(database, memberID,
                                    memberPassword)) {
                                loginCheck = 1;
                                memberSession = 1;
                            } else {
                    ...
                    case 1:
                        do {
                            ...
                            case 1:
                                ...
                                bookServicesUtil.issueBook(memberID, bookId,
                                        database);
                                break;
                            case 2:
                            ...
                            case 3:
                                BookServicesUtil
                                        .sortByAuthor(database.booksList);
                                System.out.print("Enter Book ID : ");
                                bookId = scanner.nextInt();
                                bookServicesUtil.issueBook(memberID, bookId,
                                        database);
                            ...
                            case 4:
                                BookServicesUtil
                                        .sortByRating(database.booksList);
                                System.out.print("Enter Book ID : ");
                                bookId = scanner.nextInt();
                                bookServicesUtil.issueBook(memberID, bookId,
                                        database);
                            ...
                            case 5:
                                ...
                                int bookID = scanner.nextInt();
                                bookID = BookServicesUtil.searchByID(bookID,
                                        database.booksList);
                                if (bookID != 0)
                                    bookServicesUtil.issueBook(memberID,
                                            bookID, database);
                                else
                            ...
                            case 6:
                                System.out.print("Enter Name : ");
                                String bookName = scanner.next();
                                bookID = BookServicesUtil.searchByName(
                                        bookName, database.booksList);
                                if (bookID != 0) {
                                    System.out.print("Enter ID : ");
                                    bookID = scanner.nextInt();
                                    bookServicesUtil.issueBook(memberID,
                            ...
                            case 7:
                                ...
                                bookID = BookServicesUtil.searchByAuthor(
                                        bookAuthorName, database.booksList);
                                if (bookID != 0) {
                                    System.out.print("Enter ID : ");
                                    bookID = scanner.nextInt();
                                    bookServicesUtil.issueBook(memberID,
                            ...
                            case 8:
                                ...
                                bookID = BookServicesUtil.searchByRating(
                                        bookRating, database.booksList);
                                if (bookID != 0) {
                                    System.out.print("Enter ID : ");
                                    bookID = scanner.nextInt();
                                    bookServicesUtil.issueBook(memberID,
                    ...
                    case 2:
                        ...
                        int bookId = scanner.nextInt();
                        bookServicesUtil
                                .returnBooks(memberID, bookId, database);
